...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-wu72yda.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-wu72yda.containers.anotherwebservice.com/
...
```
git clone git@github.com:00ndasub/container-wu72yda.git
cd container-wu72yda
```
...
```
docker attach container-wu72yda
```
